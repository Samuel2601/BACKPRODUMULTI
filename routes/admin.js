...
api.get('/listar_admininstitucion',auth.auth,AdminController.listar_admininstitucion);

api.get('/actualizar_admininstitucion/:id',auth.auth,AdminController.actualizar_admininstitucion);
api.get('/obtener_portada/:img',AdminController.obtener_portada);

api.post('/registrar_admin',[auth.auth,path],AdminController.registrar_admin);
...
api.get('/obtener_config_admin',auth.auth,AdminController.obtener_config_admin);
...
api.get('/obtener_detallespagos_admin/:id',auth.auth,AdminController.obtener_detallespagos_admin);
...
api.put('/eliminar_finalizado_orden/:id',auth.auth,AdminController.eliminar_finalizado_orden);
